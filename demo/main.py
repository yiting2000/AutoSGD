'''''Modified from Adaptive Gradient Methods with Dynamic Bound of Learning Rate.
...
def create_optimizer(args, model_params):
    if args.optim == 'sgd':
        ...
        t_initial=num_epoch, decay_rate=args.weight_decay, args.lr)
    else:
        assert args.optim == 'AutoSGD'
